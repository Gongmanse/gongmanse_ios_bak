...
class TabCell: UICollectionViewCell {
    ...
    var indicatorColor: UIColor = #colorLiteral(red: 0.9294117647, green: 0.462745098, blue: 0, alpha: 1)
        ...
        didSet {
            DispatchQueue.main.async {
                UIView.animate(withDuration: 0.3) {
                    ...
                    self.layoutIfNeeded()
                    if self.indicatorView.backgroundColor == #colorLiteral(red: 0.9294117647, green: 0.462745098, blue: 0, alpha: 1) {
                        self.tabTitle.textColor = #colorLiteral(red: 0.9294117647, green: 0.462745098, blue: 0, alpha: 1)
                    } else {
                        self.tabTitle.textColor = .black
                    }
                }
            }
        }
