...
class ProgressLearningVC: UIViewController {
...
extension ProgressLearningVC: TabsDelegate {
...
extension ProgressLearningVC: UIPageViewControllerDataSource, UIPageViewControllerDelegate {
    ...
    func getVCPageIndex(_ viewController: UIViewController?) -> Int {
        ...
        case is ProgressMainVC:
            let vc = viewController as! ProgressMainVC
            return vc.pageIndex
        case is ProgressScienceVC:
            let vc = viewController as! ProgressScienceVC
            return vc.pageIndex
        case is ProgressSocialVC:
            let vc = viewController as! ProgressSocialVC
            return vc.pageIndex
        case is ProgressOthers:
            let vc = viewController as! ProgressOthers
            return vc.pageIndex
        default:
            let vc = viewController as! ProgressMainVC
            return vc.pageIndex
