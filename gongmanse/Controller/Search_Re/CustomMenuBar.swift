...
class CustomMenuBar: UIView {
    ...
    func setupCollectioView(){
        ...
        customTabBarCollectionView.register(CustomMenuBar.self, forCellWithReuseIdentifier: CustomMenuBar.reusableIdentifier)
...
extension CustomMenuBar: UICollectionViewDelegate, UICollectionViewDataSource {
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        let cell = collectionView.dequeueReusableCell(withReuseIdentifier: UpperCell.reusableIdentifier, for: indexPath) as! UpperCell
        return cell
    }
