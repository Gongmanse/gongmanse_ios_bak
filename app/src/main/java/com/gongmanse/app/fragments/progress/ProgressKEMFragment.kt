...
class ProgressKEMFragment :
    Fragment(), SwipeRefreshLayout.OnRefreshListener, OnBottomSheetProgressListener {

    companion object {
        private val TAG = ProgressKEMFragment::class.java.simpleName
    }
    ...
    override fun onSelectionGrade(
        ...
        binding.tvSelectUnit.text = Constants.CONTENT_VALUE_ALL_UNIT     // 단원 "모든 단원" 초기화
    ...
    private fun initView() {
        ...
        binding.layoutUnit.setOnClickListener {
            if (grade.isNullOrEmpty()) toast("학년을 선택해 주세요.")
                ...
                bottomSheetUnit = SelectionSheetUnitTitle(this, Constants.GRADE_SORT_ID_KEM, grade, jindoTitle, gradeNum)
