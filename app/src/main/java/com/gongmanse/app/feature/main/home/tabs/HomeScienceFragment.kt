    ...
    private fun prepareData() {
        when(selectView){
            Constants.SelectValue.SORT_ALL ->{
                when(selectOrder){
                    Constants.SelectValue.SORT_AVG      -> viewModel.loadVideo( Constants.SubjectValue.SCIENCE, mOffset, Constants.DefaultValue.LIMIT_INT, Constants.SelectValue.SORT_VALUE_AVG, Constants.SubjectType.DEFAULT)
                    Constants.SelectValue.SORT_LATEST   -> viewModel.loadVideo( Constants.SubjectValue.SCIENCE, mOffset, Constants.DefaultValue.LIMIT_INT, Constants.SelectValue.SORT_VALUE_LATEST, Constants.SubjectType.DEFAULT)
                    Constants.SelectValue.SORT_NAME     -> viewModel.loadVideo( Constants.SubjectValue.SCIENCE, mOffset, Constants.DefaultValue.LIMIT_INT, Constants.SelectValue.SORT_VALUE_NAME, Constants.SubjectType.DEFAULT)
                    Constants.SelectValue.SORT_SUBJECT  -> viewModel.loadVideo( Constants.SubjectValue.SCIENCE, mOffset, Constants.DefaultValue.LIMIT_INT, Constants.SelectValue.SORT_VALUE_SUBJECT, Constants.SubjectType.DEFAULT)
                }
            }
            Constants.SelectValue.SORT_SERIES ->{
                viewModel.loadVideo(Constants.SubjectValue.SCIENCE,mOffset, Constants.DefaultValue.LIMIT_INT,null,Constants.SubjectType.SERIES)
            }
            Constants.SelectValue.SORT_PROBLEM ->{
                viewModel.loadVideo(Constants.SubjectValue.SCIENCE,mOffset, Constants.DefaultValue.LIMIT_INT,null,Constants.SubjectType.PROBLEM)
            }
            Constants.SelectValue.SORT_NOTE ->{
                viewModel.loadVideo(Constants.SubjectValue.SCIENCE,mOffset, Constants.DefaultValue.LIMIT_INT,null,Constants.SubjectType.NOTE)
            }
        }
        // 스크롤 이벤트
    ...
    private fun load(totalItemsCount: Int) {
        ...
        Handler().postDelayed({
            when(selectView){
                ...
                Constants.SelectValue.SORT_SERIES -> viewModel.loadVideo(Constants.SubjectValue.SCIENCE,mOffset, Constants.DefaultValue.LIMIT_INT,null,Constants.SubjectType.SERIES)
                Constants.SelectValue.SORT_PROBLEM -> viewModel.loadVideo(Constants.SubjectValue.SCIENCE,mOffset, Constants.DefaultValue.LIMIT_INT,null,Constants.SubjectType.PROBLEM)
                Constants.SelectValue.SORT_NOTE -> viewModel.loadVideo(Constants.SubjectValue.SCIENCE,mOffset, Constants.DefaultValue.LIMIT_INT,null,Constants.SubjectType.NOTE)
            }
