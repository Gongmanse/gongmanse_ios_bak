    ...
    private fun prepareData() {
        when(selectView){
            Constants.SelectValue.SORT_ALL ->{
                when(selectOrder){
                    Constants.SelectValue.SORT_AVG      -> videoViewModel.loadVideo( Constants.SubjectValue.SOCIETY, mOffset, Constants.DefaultValue.LIMIT_INT, Constants.SelectValue.SORT_VALUE_AVG, Constants.SubjectType.DEFAULT)
                    Constants.SelectValue.SORT_LATEST   -> videoViewModel.loadVideo( Constants.SubjectValue.SOCIETY, mOffset, Constants.DefaultValue.LIMIT_INT, Constants.SelectValue.SORT_VALUE_LATEST, Constants.SubjectType.DEFAULT)
                    Constants.SelectValue.SORT_NAME     -> videoViewModel.loadVideo( Constants.SubjectValue.SOCIETY, mOffset, Constants.DefaultValue.LIMIT_INT, Constants.SelectValue.SORT_VALUE_NAME, Constants.SubjectType.DEFAULT)
                    Constants.SelectValue.SORT_SUBJECT  -> videoViewModel.loadVideo( Constants.SubjectValue.SOCIETY, mOffset, Constants.DefaultValue.LIMIT_INT, Constants.SelectValue.SORT_VALUE_SUBJECT, Constants.SubjectType.DEFAULT)
                }
            }
            Constants.SelectValue.SORT_SERIES ->{
                videoViewModel.loadVideo(Constants.SubjectValue.SOCIETY,mOffset, Constants.DefaultValue.LIMIT_INT,null,Constants.SubjectType.SERIES)
            }
            Constants.SelectValue.SORT_PROBLEM ->{
                videoViewModel.loadVideo(Constants.SubjectValue.SOCIETY,mOffset, Constants.DefaultValue.LIMIT_INT,null,Constants.SubjectType.PROBLEM)
            }
            Constants.SelectValue.SORT_NOTE ->{
                videoViewModel.loadVideo(Constants.SubjectValue.SOCIETY,mOffset, Constants.DefaultValue.LIMIT_INT,null,Constants.SubjectType.NOTE)
            }
        }
        // 스크롤 이벤트
    ...
    private fun load(totalItemsCount: Int) {
        ...
        Handler(Looper.getMainLooper()).postDelayed({
            when(selectView){
                ...
                Constants.SelectValue.SORT_SERIES -> videoViewModel.loadVideo(Constants.SubjectValue.SOCIETY,mOffset, Constants.DefaultValue.LIMIT_INT,null,Constants.SubjectType.SERIES)
                Constants.SelectValue.SORT_PROBLEM -> videoViewModel.loadVideo(Constants.SubjectValue.SOCIETY,mOffset, Constants.DefaultValue.LIMIT_INT,null,Constants.SubjectType.PROBLEM)
                Constants.SelectValue.SORT_NOTE -> videoViewModel.loadVideo(Constants.SubjectValue.SOCIETY,mOffset, Constants.DefaultValue.LIMIT_INT,null,Constants.SubjectType.NOTE)
            }
